          ...
          <div id="main-menu" className="main-menu collapse navbar-collapse">
            <ul className="nav navbar-nav">
              ...
              <li className="menu-item-has-children dropdown">
                ...
                >
                  {" "}
                  <i className="menu-icon fa fa-table"></i>Tables
                </a>
                <ul className="sub-menu children dropdown-menu">
                  <li>
              ...
              <li className="menu-item-has-children dropdown">
                ...
                >
                  {" "}
                  <i className="menu-icon fa fa-tasks"></i>Icons
                </a>
                <ul className="sub-menu children dropdown-menu">
                  <li>
              ...
              <li className="menu-item-has-children dropdown">
                ...
                >
                  {" "}
                  <i className="menu-icon fa fa-bar-chart"></i>Charts
                </a>
                <ul className="sub-menu children dropdown-menu">
                  <li>
              ...
              <li className="menu-item-has-children dropdown">
                ...
                >
                  {" "}
                  <i className="menu-icon fa fa-area-chart"></i>Maps
                </a>
                <ul className="sub-menu children dropdown-menu">
                  <li>
              ...
              <li className="menu-item-has-children dropdown">
                ...
                >
                  {" "}
                  <i className="menu-icon fa fa-glass"></i>Pages
                </a>
                <ul className="sub-menu children dropdown-menu">
                  <li>
